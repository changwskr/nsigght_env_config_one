...
[Tomcat Cluster: tomcat-01 / tomcat-02]  (32 vCPU / 256GB x 2)
...
| Tomcat Thread | `maxThreads=3200`, `maxConnections=50000` |
| HikariCP RDW | `maximum-pool-size=200`, `minimum-idle=64` |
| HikariCP APPLOG | `maximum-pool-size=64`, `minimum-idle=16` |
